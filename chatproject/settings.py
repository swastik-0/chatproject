...
# In production (DEBUG=False), use WhiteNoise's hashed/compressed storage.
# In development (DEBUG=True), use the default storage so static files are
# served directly without needing to run collectstatic first.
STORAGES = {
    "default": {
